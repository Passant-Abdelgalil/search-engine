...
public class URINormalizer {
    ...
    public String normalize(String url){
        url = normalizePreservedSemantics(url);
        url = normalizeSemantics(url);
        return url;
    }
    ...
    private String CapitalLetterDecoding(String url){
    ...
    private  String LowerLetterDecoding(String url){
        /*  LOWER LETTER DECODING */
        Pattern pattern = Pattern.compile("%6[1-9]");
        Matcher matcher = pattern.matcher(url);
        while (matcher.find()) {
            url = url.replaceAll(matcher.group(0), String.valueOf(matcher.group(0).charAt(2) - 1 + 'a'));
        }
    ...
    private String decodeLetter(String url) {
        url = CapitalLetterDecoding(url);
        url = LowerLetterDecoding(url);
        return url;
    }
    ...
    public static void main(String... args) {
        ...
        //URI url = new URI("https://apps.apple.com/app/apple-store/id305343404?mt=8#ac-gn-menustate");
        URINormalizer normalizer = new URINormalizer();
        String url = normalizer.normalizePreservedSemantics("https://apps.apple.com/app/apple-store/id305343404?mt=8#ac-gn-menustate");
        url = normalizer.normalizeSemantics(url);
