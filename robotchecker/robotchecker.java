...
public class RobotChecker {
    ...
    public boolean isAllowed(String url) throws MalformedURLException {
        ...
        String host = new URL(url).getHost(); // get host name from the url
    ...
    public static void main(String... args){
        ...
        try {
            checker.getRules("https://www.stackoverflow.com");
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
        try {
            if(checker.isAllowed("https://stackoverflow.com/users/signup")){
